...
class AdminController {
  ...
  getDeletionImpact = async (req, res, next) => {
    try {
      const impact = await this.service.getDeletionImpact(req.params.id);
  ...
  getMenuItemLinkCount = async (req, res, next) => {
    try {
      const count = await this.service.getMenuItemLinkCount(req.params.id);
