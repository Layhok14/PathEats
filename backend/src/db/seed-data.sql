...
BEGIN
  ...
  FOR i IN 1..1000 LOOP
    ...
    FOR j IN 1..item_count LOOP
      ...
      INSERT INTO menu_items (place_id, name, description, price, category)
      VALUES (p_id, item_name, 'Freshly prepared ' || item_name, round(item_price::numeric, 2), item_cat);
    END LOOP;
...
INSERT INTO "role" (name, table_privileges, grant_option) VALUES
  ('CONSUMER', '{"users": ["SELECT"], "reviews": ["SELECT", "INSERT"]}'::jsonb, FALSE),
