...
const sections = [
  {
    ...
    items: [
      ...
      { label: "Messages", path: "/admin/messages", icon: "M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H5.17L4 17.17V4h16v12z", badge: true, description: "Consumer support messages & inquiries" },
    ],
  },
  {
    title: "Vendor Operations",
    subtitle: "Vendor & stall management",
    items: [
      { label: "Vendor Management", path: "/admin/restaurants", icon: "M18.06 22.99h1.66c.84 0 1.53-.64 1.63-1.46L23 5.05h-5V1h-1.97v4.05h-4.97l.3 2.34c1.71.47 3.31 1.32 4.27 2.26 1.44 1.42 2.43 2.89 2.43 5.29v8.05zM1 21.99V21h15.03v.99c0 .55-.45 1-1.01 1H2.01c-.56 0-1.01-.45-1.01-1zm15.03-7c0-3.5-3.37-5.99-7.52-5.99S1 11.49 1 14.99v1h15.03v-1z", badge: false, description: "Manage all stalls, menu items, reviews & vendors" },
    ],
  },
  {
    title: "Developer",
    ...
    items: [
      ...
      { label: "Backups", path: "/admin/backups", icon: "M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM14 13v4h-4v-4H7l5-5 5 5h-3z", badge: false, description: "Database backup management & scheduling" },
      { label: "Recovery", path: "/admin/recovery", icon: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z", badge: false, description: "System recovery & restore operations" },
...
export default function AdminMainLayout() {
  ...
  useEffect(() => {
    api.get("/admin/messages/count/open").then(r => setOpenCount(r.data.data.count)).catch(() => {});
