...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Stall Directory", path: "/admin/stalls", icon: "M4 4h16v4H4V4zm1 6h14l-1 10H6L5 10zm4 2v6h2v-6H9zm4 0v6h2v-6h-2z", badge: false, description: "View every stall, including unassigned stalls" },
