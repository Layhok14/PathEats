...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "User Diagnostics", path: "/admin/developer/users", icon: "M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5z", badge: false, description: "Inspect user records, preferences, search history, and account status" },
      { label: "Vendor Diagnostics", path: "/admin/developer/vendors", icon: "M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V6h16v12zM6 10h2v2H6zm0 4h8v2H6zm10 0h2v2h-2zm-6-4h8v2h-8z", badge: false, description: "Inspect vendor-linked records across stalls, menus, hours, and reviews" },
      { label: "Review Diagnostics", path: "/admin/developer/reviews", icon: "M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z", badge: false, description: "Inspect system-wide review data for developer analysis" },
      { label: "Backup & Recovery", path: "/admin/backups", roles: ["DEVELOPER_ADMIN"], icon: "M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM14 13v4h-4v-4H7l5-5 5 5h-3z", badge: false, description: "Database backups, scheduling & restore operations" },
...
export default function AdminMainLayout() {
  ...
  const visibleSections = sections
    .map((section) => ({
      ...section,
      items: section.items.filter((item) => item.path !== "/admin/dashboard" && roleAllowed(item.roles ?? section.roles)),
    }))
