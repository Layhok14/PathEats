...
export const PHNOM_PENH_CENTER = [11.5572, 104.9180];
export const ROADMAP_TILE = "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png";
...
export const CUISINES = ["Khmer", "Noodles", "BBQ", "Rice", "Banh Mi", "Chinese", "Dessert", "Drinks"];
export const PRICE_LABELS = ["", "$", "$$", "$$$", "$$$$"];

export const PLACES = [
  { name: "Central Market (Phsar Thmei)",           lat: 11.5699, lng: 104.9170 },
  { name: "Russian Market (Phsar Toul Tom Poung)",  lat: 11.5445, lng: 104.9186 },
  { name: "Royal Palace",                           lat: 11.5642, lng: 104.9302 },
  { name: "Independence Monument",                  lat: 11.5533, lng: 104.9283 },
  { name: "Olympic Stadium",                        lat: 11.5530, lng: 104.9139 },
  { name: "BKK1 (Boeung Keng Kang 1)",              lat: 11.5564, lng: 104.9282 },
  { name: "Riverside (Sisowath Quay)",              lat: 11.5700, lng: 104.9313 },
  ...
  { name: "Phnom Penh International Airport",       lat: 11.5466, lng: 104.8440 },
  { name: "Night Market (Sisowath Quay)",           lat: 11.5640, lng: 104.9307 },
