import type { User, Ticket, Restaurant, ActivityItem, GrowthDataPoint } from "../types";

export const MOCK_USERS: User[] = [
  { id: "u1", name: "Sarah Jenkins", email: "sarah.j@university.edu", role: "Student", status: "Active", avatarUrl: undefined, avatarInitials: "SJ", avatarColor: "#e0f2fe" },
...
export const PENDING_RESTAURANTS: Restaurant[] = [
...
export const ACTIVE_RESTAURANTS: Restaurant[] = [
...
export const SYSTEM_ACTIVITY: ActivityItem[] = [
