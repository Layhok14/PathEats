      ...
      <aside className="w-[260px] flex flex-col h-full shrink-0" style={{ background: "#004b1e" }}>
        ...
        <div className="px-4 pb-2 flex flex-col gap-1" style={{ borderTop: "1px solid rgba(188,203,185,0.15)" }}>
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2.5 mt-3 rounded-lg text-[12px] font-medium transition-all text-[#bec6e0] hover:bg-white/10 hover:text-white"
          >
            <svg width="15" height="15" fill="currentColor" viewBox="0 0 24 24"><path d="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z" /></svg>
            Developer Portal
          </button>
          {/* User footer */}
